            ...
            <div class="flex items-center justify-between h-16 px-4 bg-green-950">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-10 h-10 bg-gradient-to-br from-green-400 to-orange-500 rounded-lg flex items-center justify-center">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
            <div class="flex flex-col flex-grow bg-gradient-to-b from-green-900 to-green-800 overflow-y-auto">
                ...
                <div class="flex items-center flex-shrink-0 px-6 py-5 bg-green-950">
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-gradient-to-br from-green-400 to-orange-500 rounded-lg flex items-center justify-center shadow-lg">
                            <span class="text-white font-bold text-xl">CA</span>
                        </div>
                        <span class="ml-3 text-white font-semibold text-lg">CA Global</span>
                    </div>
                ...
                <div class="flex flex-1 justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button class="p-2 text-gray-400 hover:text-gray-500 relative">
                            ...
                            <span class="absolute top-1.5 right-1.5 block h-2 w-2 rounded-full bg-orange-500 ring-2 ring-white"></span>
                        </button>
