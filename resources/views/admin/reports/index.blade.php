        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.reports.attendance') }}" class="group">
                    <div
                        class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 hover:shadow-lg transition">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <svg class="w-5 h-5 text-white/60 group-hover:text-white group-hover:translate-x-1 transition"
                        ...
                        <p class="text-white/80 text-sm">View detailed attendance records with filters and export
                            options</p>
                    </div>
                </a>
                ...
                <div class="group cursor-pointer">
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-6 hover:shadow-lg transition">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs font-medium px-2 py-1 bg-white/20 text-white rounded">Coming
                                Soon</span>
                        </div>
                ...
                <div class="group cursor-pointer">
                    <div
                        class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-6 hover:shadow-lg transition">
                        <div class="flex items-center justify-between mb-4">
                            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="group cursor-pointer">
                    <div
                        class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 hover:shadow-lg transition">
                        <div class="flex items-center justify-between mb-4">
                            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
