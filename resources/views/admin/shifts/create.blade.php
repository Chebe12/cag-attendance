...
@section('content')
<div x-data="{
    days: {{ old('days') ? json_encode(old('days')) : '[]' }},
    toggleDay(day) {
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Create New Shift</h1>
                <p class="mt-2 text-sm text-gray-700">Add a new work shift</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <textarea name="location"
                                      id="location"
                                      rows="3"
                                      placeholder="Enter shift location or address"
                                      class="block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 @error('location') border-red-500 @enderror">{{ old('location') }}</textarea>
                            @error('location')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  id="description"
                                  rows="4"
                                  placeholder="Add any additional notes or instructions for this shift"
                                  class="block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
