            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('description', $department->description) }}</textarea>
                ...
                <div>
                    ...
                    <select name="head_of_department"
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('head_of_department', $department->head_of_department) == $user->id ? 'selected' : '' }}>
